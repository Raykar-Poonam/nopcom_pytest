...
class Test_URL_Login:
    ...
    @pytest.mark.sanity
    def test_user_login_002(self, setup):       #testcase
        self.log.info("Test_case test_user_login_002 is started")
        self.driver = setup
        self.log.info("Opening browser and navigating to demo_nop_com")
        self.lp = LoginClass(self.driver)                   # self.lp = self.driver
...
# D:\Credence\Tushar Sir\selenium Part  2\Project_tusharsir\Pytest_Nopcommerce\Logs
